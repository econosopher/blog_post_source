...
# Try to load gec_theme - it might be from gectheme or gec package
# Common possibilities:
# library(gectheme)
# library(gec)
# Or it might be a custom theme function
...
# Source the gec_theme
source("../gec_theme/gec_gt_theme.R")

cat("Applying gec_theme...\n")
...
# Save the test table
gtsave(gini_table, "visualizations/us_games_volatility_with_countries_gec_test.png", expand = 20)

cat("\nTest table saved to: visualizations/us_games_volatility_with_countries_gec_test.png\n")